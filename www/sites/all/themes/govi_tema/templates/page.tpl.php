    ...
    <section class="encabezado-b pure-g">
        <div class="contenedor">
            <?php if (!empty($page['header_entidad'])): ?>
                <?php if ($logo): ?>
                    <div class="pure-u-1-5 pure-u-sm-1 pure-u-md-1-5 pure-u-lg-1-5 pure-u-xl-1-5">
                ...
                <?php if (!empty($page['header_sector'])): ?>
                    <div class="encabezado-b-2 pure-u-3-5 pure-u-sm-1 pure-u-md-3-5 pure-u-lg-3-5 pure-u-xl-3-5">
                ...
                <?php endif; ?>
                    ...
                    <?php if (!empty($page['encabezado_b_1'])): ?>
                        <div class="encabezado-b-1 pure-u-1-5 pure-u-sm-1 pure-u-md-1-5 pure-u-lg-1-5 pure-u-xl-1-5">
            ...
            <?php else:?>
                    ...
                    <?php if (!empty($page['encabezado_b_3'])): ?>
                        <div class="encabezado-b-3 pure-u-1-5 pure-u-sm-1 pure-u-md-1-5 pure-u-lg-1-5 pure-u-xl-1-5">
